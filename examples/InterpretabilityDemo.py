...
n_clauses = 10
tm = MultiClassTsetlinMachine(n_clauses, 15, 3.0, dlri = True,
                              number_of_state_bits=4, boost_true_positive_feedback=0)

tm.fit(X_train, Y_train, epochs=2)
...
for j in range(0, 4, 2):
    ...
    for k in range(number_of_features*2):
        print("Get state for feature="+str(k)+"*************************************")
